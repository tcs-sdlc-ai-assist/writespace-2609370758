...
export default function App() {
  ...
  return (
    <div className="min-h-screen">
      ...
      <Routes>
        <Route path="/" element={<Placeholder title="A place for considered words." />} />
        <Route path="/login" element={<LoginPage />} />
        <Route path="/register" element={<RegisterPage />} />
        <Route path="/blogs" element={<ProtectedRoute mode="auth"><Placeholder title="All blogs" /></ProtectedRoute>} />
        <Route path="/blog/:id" element={<ProtectedRoute mode="auth"><Placeholder title="Read a blog" /></ProtectedRoute>} />
