  ...
  return (
    <main className="grid min-h-[calc(100vh-73px)] place-items-center px-5 py-12">
      <section className="w-full max-w-md rounded-3xl border border-stone-200 bg-white p-8 shadow-editorial sm:p-10">
        ...
        <p className="mt-6 border-t border-stone-100 pt-4 text-xs leading-5 text-stone-500">
          Demo admin: <strong>admin / admin</strong>. Credentials stay in this browser and are not secure.
        </p>
      </section>
    </main>
  );
